                    ...
                    {levels.map((level) => (
                      ...
                      >
                        <div className={sidebarStyles.levelButtonContent}>
                          <span className={sidebarStyles.levelIcon}>{level.icon}</span>
          ...
          <div className={sidebarStyles.sidebarFooter}>
            <div className={sidebarStyles.footerContent}>
                <div className={sidebarStyles.footerContentCenter}>
                    <p>Master your skills one quiz ata a time</p>
                    <p className={sidebarStyles.footerHighlight}>Keep Learning and Keep Growing</p>
                </div>
